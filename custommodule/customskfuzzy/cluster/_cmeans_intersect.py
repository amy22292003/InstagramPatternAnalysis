...
# data1:coordinate; similarity2:tag intersect similarity
def _cmeans0_locationfreq(data1, similarity2, u_old, c, w, m, k):
	"""
	Single step in generic fuzzy c-means clustering algorithm.
	data2 is for intersect counting
	"""
...
def cmeans(data1, similarity2, c, w, m, error, maxiter, algorithm="Original", para=None, init=None, seed=None):
	"""
	data2 is for intersect counting
	"""
	# Setup u0
	...
	if algorithm is "LocationFrequency":
		_cmeans0 = _cmeans0_locationfreq
	else:
