...
def cmeans_intersect(coordinate, similarity, cluster_num, w = 0.4, algorithm="Original", para=10):
    print("-fuzzy c means - gps + relation")
    cntr1, u, u0, d1, d2, d, jm, p, fpc = cskfuzzy.cluster.cmeans_intersect(coordinate, similarity, cluster_num, w, 2, error=0.000001, maxiter=100000, algorithm=algorithm, para=para)
    cluster_membership = numpy.argmax(u, axis=0)
